...
$offset_bytes = 0x0A,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x30,0x30,0x30,0x30,0x30,0x30,0x33,0x30,0x3A
...
$offset = $text.IndexOf($offset_text) + 0x3C
$bytes[$offset] = 0x31
