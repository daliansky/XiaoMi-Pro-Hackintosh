...
// USB power injection (work with SSDT-EC) and patch USB ports to enable WLAN_LTE slot (work with _UPC rename)

// HS01 -> HS USB3 near right
// HS02 -> WLAN_LTE, might only available on TM1701
// HS03 -> HS USB3 near left
// HS04 -> HS USB3 far right
// HS05 -> bluetooth (Disabled)
// HS06 -> camera
// HS07 -> SD card reader
// HS08 -> fingerprint (Disabled)
